...
const AGENT_CONFIG = {
  name: 'Test Agent base-mainnet',
  description: 'Comprehensive test agent for base-mainnet',
  image: 'https://example.com/test-agent.png',
  // Update these URLs when you deploy your agent
  a2aEndpoint: 'https://test-agent-base-mainnet.example.com/.well-known/agent-card.json',
  mcpEndpoint: 'https://test-agent-base-mainnet.example.com/mcp',
};
