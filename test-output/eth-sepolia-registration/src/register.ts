...
const AGENT_CONFIG = {
  name: 'Test Agent eth-sepolia',
  description: 'Comprehensive test agent for eth-sepolia',
  image: 'https://example.com/test-agent.png',
  // Update these URLs when you deploy your agent
  a2aEndpoint: 'https://test-agent-eth-sepolia.example.com/.well-known/agent-card.json',
  mcpEndpoint: 'https://test-agent-eth-sepolia.example.com/mcp',
};
