# Test Agent polygon-mainnet

Comprehensive test agent for polygon-mainnet
...
**⚠️ Mainnet: You need real MATIC for gas fees.** Transfer MATIC to your wallet before registering.
...
- Register your agent on Polygon Mainnet
