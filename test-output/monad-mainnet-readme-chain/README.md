# Test Agent monad-mainnet

Comprehensive test agent for monad-mainnet
...
**⚠️ Mainnet: You need real MON for gas fees.** Transfer MON to your wallet before registering.
...
- Register your agent on Monad Mainnet
