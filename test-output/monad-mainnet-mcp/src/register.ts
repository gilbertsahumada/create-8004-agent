...
const AGENT_CONFIG = {
  ...
  a2aEndpoint: 'https://test-agent-monad-mainnet.example.com/.well-known/agent-card.json',
  mcpEndpoint: 'https://test-agent-monad-mainnet.example.com/mcp',
};
...
async function main() {
  ...
  console.log('⛓️  Registering agent on Monad Mainnet...');
  ...
  console.log('');
   ...
   console.log(`   https://www.8004scan.io/agents/monad/${agentIdNum}`);
  console.log('');
