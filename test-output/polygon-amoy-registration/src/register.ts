...
const AGENT_CONFIG = {
  name: 'Test Agent polygon-amoy',
  description: 'Comprehensive test agent for polygon-amoy',
  image: 'https://example.com/test-agent.png',
  // Update these URLs when you deploy your agent
  a2aEndpoint: 'https://test-agent-polygon-amoy.example.com/.well-known/agent-card.json',
  mcpEndpoint: 'https://test-agent-polygon-amoy.example.com/mcp',
};
...
async function main() {
  ...
  console.log('⛓️  Registering agent on Polygon Amoy (Testnet)...');
  ...
  console.log('');
   ...
   console.log(`   https://www.8004scan.io/agents/polygon-amoy/${agentIdNum}`);
  console.log('');
