...
const AGENT_CONFIG = {
  name: 'Test Agent base-sepolia',
  description: 'Comprehensive test agent for base-sepolia',
  image: 'https://example.com/test-agent.png',
  // Update these URLs when you deploy your agent
  a2aEndpoint: 'https://test-agent-base-sepolia.example.com/.well-known/agent-card.json',
  mcpEndpoint: 'https://test-agent-base-sepolia.example.com/mcp',
};
