...
const AGENT_CONFIG = {
  name: 'Test Agent polygon-mainnet',
  description: 'Comprehensive test agent for polygon-mainnet',
  image: 'https://example.com/test-agent.png',
  // Update these URLs when you deploy your agent
  a2aEndpoint: 'https://test-agent-polygon-mainnet.example.com/.well-known/agent-card.json',
  mcpEndpoint: 'https://test-agent-polygon-mainnet.example.com/mcp',
};
...
async function main() {
  ...
  console.log('⛓️  Registering agent on Polygon Mainnet...');
  ...
  console.log('');
   ...
   console.log(`   https://www.8004scan.io/agents/polygon/${agentIdNum}`);
  console.log('');
