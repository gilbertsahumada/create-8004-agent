...
const AGENT_CONFIG = {
  name: 'Test Agent monad-testnet',
  description: 'Comprehensive test agent for monad-testnet',
  image: 'https://example.com/test-agent.png',
  // Update these URLs when you deploy your agent
  a2aEndpoint: 'https://test-agent-monad-testnet.example.com/.well-known/agent-card.json',
  mcpEndpoint: 'https://test-agent-monad-testnet.example.com/mcp',
};
...
async function main() {
  ...
  console.log('⛓️  Registering agent on Monad Testnet...');
  ...
  console.log('');
   ...
   console.log(`   https://www.8004scan.io/agents/monad-testnet/${agentIdNum}`);
  console.log('');
