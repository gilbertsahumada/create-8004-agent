...
const AGENT_CONFIG = {
  name: 'Test Agent eth-mainnet',
  description: 'Comprehensive test agent for eth-mainnet',
  image: 'https://example.com/test-agent.png',
  // Update these URLs when you deploy your agent
  a2aEndpoint: 'https://test-agent-eth-mainnet.example.com/.well-known/agent-card.json',
  mcpEndpoint: 'https://test-agent-eth-mainnet.example.com/mcp',
};
...
async function main() {
  ...
  console.log('⛓️  Registering agent on Ethereum Mainnet...');
  ...
  console.log('');
   ...
   console.log(`   https://www.8004scan.io/agents/mainnet/${agentIdNum}`);
  console.log('');
